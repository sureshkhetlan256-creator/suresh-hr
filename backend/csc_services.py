"""CSC (Common Service Centre) services catalog — used by both backend and frontend
via the frontend copy at /app/frontend/src/lib/cscServices.js."""

CSC_CATEGORIES = [
    {
        "id": "vacancy",
        "hi": "ऑनलाइन फॉर्म · नई भर्ती",
        "en": "Online Forms · New Vacancy",
        "icon": "FaIdCard",
        "services": [
    ...
    {
        "id": "certificates",
        "hi": "सरकारी प्रमाणपत्र",
        "en": "Government Certificates",
    ...
    {
        "id": "bills",
        "hi": "बिल भुगतान एवं रिचार्ज",
        "en": "Bill Payment & Recharge",
        "icon": "FaBolt",
        "services": [
...
def all_service_ids() -> set:
    return {s["id"] for cat in CSC_CATEGORIES for s in cat["services"]}


def find_service(sid: str):
    for cat in CSC_CATEGORIES:
